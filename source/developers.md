...
The bot is represented by the [`Bot`](https://github.com/phergie/phergie-irc-bot-react/blob/master/src/Bot.php) class, which is used by the [bot runner](https://github.com/phergie/phergie-irc-bot-react/blob/master/bin/phergie). In addition to the [[logger|Usage#logging]], this class supports replacing other dependencies via configuration.
